...
<main class="flex-grow flex-col flex items-center justify-center p-2">
  <form hx-post="/admin/login" hx-trigger="submit" hx-target="#error" class="flex flex-col gap-8">
    ...
    <div class="flex-col flex gap-4">
      <Input\Generic id="username" name="username" required="true" placeholder="<?= _('Digite seu usuário...') ?>"
        label="<?= _('Usuário') ?>">
      </Input\Generic>

      <Input\Generic id="password" name="password" type="password" required="true"
